...
// Each stage is tri-state: only blank (null) counts as pending here — an
// explicit ✗ means that stage is resolved/not applicable and the pipeline
// moves on to check the next one, matching the backend's logic exactly.
