...
export const taskBaseSchema = z.object({
  ...
  cadDone: z.boolean().nullable().optional(),
  previewSent: z.boolean().nullable().optional(),
  cadConfirm: z.boolean().nullable().optional(),
  stlSend: z.boolean().nullable().optional(),
  renderReq: z.boolean().optional().default(false),
  renderPhotos: z.boolean().nullable().optional(),
  renderVideos: z.boolean().nullable().optional(),
